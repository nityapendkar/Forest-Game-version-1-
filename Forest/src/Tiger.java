...
/**
 * The Tiger class extends from the Feline class. Its superclass is the Feline class.
...
String result="";
		...
		if(a==1) {
			...
			System.out.println("Tiger from ("+ attacker_initial.getX() + ", " + attacker_initial.getY() +") attacks Tiger at ("+  victim_position.getX() + ", " 
					+ victim_position.getY() +") and loses");
			System.out.println("Tiger dies at (" + attacker_initial.getX() + ", " + attacker_initial.getY() +
					")");
